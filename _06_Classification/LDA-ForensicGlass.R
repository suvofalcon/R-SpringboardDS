# ******************************************************************************************************
# Linear Discriminant Analysis - Forensic Glass Dataset
# 
...
# We run the LDA alogorithm
lda_model <- lda(type~., data = fgl_train)

# With this model, we run the prediction on the test dataset
lda_prediction <- predict(lda_model, fgl_test)

# Lets generate the confusionMatrix to see the efficiency of the model
confusionMatrix(lda_prediction$class, fgl_test$type)
